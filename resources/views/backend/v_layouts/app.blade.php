...
asset('backend/images/icon_univ_bsi.png') }}"> 
...
sunset"></i> //--> 
                            <!-- Dark Logo icon --> 
                            <img src="{{ asset('backend/images/icon_univ_bsi.png') }}" 
alt="homepage" class="light-logo" /> 
                        ...
                        <span class="logo-text"> 
                            <!-- dark Logo text --> 
                            <img src="{{ asset('backend/images/logo_text.png') }}" alt="homepage" 
class="light-logo" /> 
 ...
 <!-- ============================================================== --> 
                          <li class="nav-item dropdown"> 
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 
                                ...
                                @else 
<img src="{{ asset('storage/images/img-default.jpg') }}" alt="user" class="rounded-circle" width="31"> 
                                @endif 
                            </a> 
                            <div class="dropdown-menu dropdown-menu-right user-dd animated"> 
                                <a class="dropdown-item" href="{{ 
route('backend.user.edit', Auth::user()->id) }}"><i class="ti-user m-r-5 m-l-5"></i> Profil Saya</a> 
                                <a class="dropdown-item" href="" 
...
effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-shopping"></i><span class="hide-menu">Data Produk </span></a> 
...
class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span class="hide-menu"> Produk 
                         ...
                         <li class="sidebar-item"> <a class="sidebar-link has-arrow waves
effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Laporan </span></a> 
                            <ul aria-expanded="false" class="collapse  first-level"> 
                                <li class="sidebar-item"><a href="{{ route('backend.laporan.formuser') }}" class="sidebar-link"><i class="mdi mdi-chevron
...
none"> 
    ...
    <!-- form keluar app end --> 
     ...
     <!-- sweetalert --> 
    <script src="{{ asset('storage/sweetalert/sweetalert2.all.min.js') }}"></script> 
    <!-- sweetalert End --> 
    <!-- konfirmasi success--> 
    @if (session('success')) 
    <script> 
...
<script>
    ...
    function previewFoto() {
        ...
        fotoReader.readAsDataURL(fotoInput.files[0]);
